...
function SHA1(source) { // @arg String: source string
                        ...
                        // @help: SHA1
//{@assert
    _if(typeof source !== "string", "invalid SHA1(source)");
//}@assert

    var sha1 = SHA1_encode(Binary.BinaryStringToUintArray(source)).map(function(value) {
...
function SHA1_encode(source) { // @arg ByteArray: [byte, ...]
                               ...
                               // @help: SHA1.encode
//{@assert
    _if(!Array.isArray(source), "invalid SHA1.encode(source)");
//}@assert
